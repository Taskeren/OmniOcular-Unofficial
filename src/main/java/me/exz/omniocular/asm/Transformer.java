                ...
                if (mn.name.equals("getWailaBody")) {
                    ...
                    if (n != null) {
                        mn.instructions.insertBefore(
                            ...
                            new FieldInsnNode(
                                Opcodes.GETSTATIC,
                                "mcp/mobius/waila/api/impl/DataAccessorFMP",
                                "instance",
                                "Lmcp/mobius/waila/api/impl/DataAccessorFMP;"));
                        ...
                        mn.instructions.insertBefore(
                            ...
                            new MethodInsnNode(
                                ...
                                "mcp/mobius/waila/api/impl/DataAccessorFMP",
                                "set",
                                "(Lnet/minecraft/world/World;Lnet/minecraft/entity/player/EntityPlayer;Lnet/minecraft/util/MovingObjectPosition;Lnet/minecraft/nbt/NBTTagCompound;Ljava/lang/String;)V",
                                false));
                        ...
                        mn.instructions.insertBefore(
                            ...
                            new MethodInsnNode(
                                ...
                                "me/exz/omniocular/handler/FMPHandler",
                                "getWailaBody",
                                "(Ljava/util/List;Lmcp/mobius/waila/api/IWailaFMPAccessor;)Ljava/util/List;",
                                false));
